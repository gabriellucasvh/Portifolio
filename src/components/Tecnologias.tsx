        ...
        <div id="tecnologias" className="pt-16 md:pt-20 mx-auto container md:w-8/12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 justify-items-center gap-8">
                {[
                    ...
                    <div key={index} className="flex flex-col items-center bg-gradient-to-b from-blue-950/5 to-blue-950 w-40 md:w-48 h-40 md:h-48 p-4 rounded-lg shadow-md" data-aos="fade-up">
                        <Image
