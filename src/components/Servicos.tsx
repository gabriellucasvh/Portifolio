...
const Servicos = () => {
    return (
        <div id="servicos" className="mx-4 md:mx-10 pt-16 md:pt-32">
            <h1 className="flex justify-center font-medium text-2xl md:text-4xl mb-10 md:mb-20" data-aos="fade-down">Serviços</h1>
            <div className="flex flex-col space-y-6">
                <div className="flex flex-col space-y-4">
                    {[
                        ...
                        <div key={index} className="flex flex-col md:flex-row p-6 bg-gradient-to-r from-blue-950/50 to-blue-900 rounded-2xl text-white" data-aos="fade-up">
