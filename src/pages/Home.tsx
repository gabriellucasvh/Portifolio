const Home = () => {
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center pb-5 -mt-24" id="sobre">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full p-4">
        <section className="p-2 text-justify">
          ...
          <p className="indent-5 text-break">
            Comecei minha jornada na programação em 2020, quando vi os famosos bots do Discord e me perguntei: "Como é possível isso atender às minhas necessidades?". Decidi criar meu próprio bot e conheci o <b>JavaScript</b>. Desde então, tenho me dedicado arduamente ao aprendizado e à prática, buscando sempre aperfeiçoar minhas habilidades e expandir meu conhecimento no vasto universo da programação.
          </p>
