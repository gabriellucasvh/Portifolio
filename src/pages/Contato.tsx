...
const Contato = () => {
  return (
    <div id='contato' className="relative w-full min-h-screen flex items-center justify-center p-5">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full">
        <section className="p-5 text-center md:text-left">
          ...
          <a href="mailto:gabriellucasvh@gmail.com">
            <div className="flex justify-center md:justify-start items-center p-2 pl-4 mb-5 rounded-xl border max-w-xs md:max-w-sm border-blue-500 transacao-lateral">
          ...
          <div className='flex justify-center md:justify-start items-center p-2 pl-4 mb-5 gap-10'>
            <a href="https://github.com/gabriellucasvh" target='_blank'>
              <FontAwesomeIcon className='w-7 h-7 hover:opacity-75' icon={faGithub} />
            </a>
            <a href="https://linkedin.com/in/gabriellucasvh/" target='_blank'>
